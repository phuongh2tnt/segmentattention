...
from your_swinunet_module import SwinUNet  # Thay thế 'your_swinunet_module' bằng tên module của bạn
...
if __name__ == "__main__":
    ...
    for epoch in range(cmd_args.epochs):
        ...
        if valid_perf > max_perf:
            ...
            torch.save(model.state_dict(), cmd_args.checkpoint + '/swinunet_epoch_' + str(epoch) +
